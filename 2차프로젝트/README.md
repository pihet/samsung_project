...
| 순위 | 알고리즘 명칭 | 방법론 분류 | Makespan (일) | 지연 블록 수 (비율) | 평균 지연일수 (일) | 정반 가동률 (%) | 4대 제약 위반 (건) | 100% 실행 가능 여부 | 데이터 무결성 | 계산 소요시간 |
|:---:|:---|:---|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|
| **1** | **Google OR-Tools CP-SAT (Ours)** | **수학적 최적화 (CP-SAT)** | **1,210** | **246 (28.21%)** | **50.53** | **29.41%** | **0** | **YES** | **PASS** | **18.76s (Measured)** |
| 2 | EST Heuristic (Unified Sim) | 규칙 기반 휴리스틱 | 1,254 | 248 (28.44%) | 55.80 | 28.37% | 0 | YES | PASS | 0.15s (Measured) |
| 3 | LPT Heuristic (Unified Sim) | 규칙 기반 휴리스틱 | 1,438 | 623 (71.44%) | 211.10 | 24.74% | 0 | YES | PASS | 0.15s (Measured) |
| 4 | SPT Heuristic (Unified Sim) | 규칙 기반 휴리스틱 | 1,474 | 528 (60.55%) | 174.60 | 24.14% | 0 | YES | PASS | 0.15s (Measured) |
| 5 | RTB Heuristic (Unified Sim) | 규칙 기반 휴리스틱 | 1,560 | 677 (77.64%) | 251.09 | 22.81% | 0 | YES | PASS | 0.15s (Measured) |
| 6 | PPO Actor-Critic (Ours) | 심층 강화학습 (RL) | 1,766 | 613 (70.30%) | 155.48 | 20.15% | 0 | YES | PASS | 0.05s (Measured) |
| 7 | RUB Heuristic (Unified Sim) | 규칙 기반 휴리스틱 | 1,969 | 734 (84.17%) | 322.50 | 18.07% | 0 | YES | PASS | 0.15s (Measured) |

### B. 연구 논문 원본 베이스라인 (Historical Paper Baselines - Figure 10 Reference)
> **참고 (Disclaimer)**: 논문 베이스라인은 원본 논문 실험 환경에서 정반 내부 2D 동시 배치를 가정한 결과입니다.
| 알고리즘 명칭 | 방법론 분류 | Makespan (일) | 지연 블록 수 (비율) | 평균 지연일수 (일) | 정반 가동률 (%) | 데이터 무결성 | 비고 |
|:---|:---|:---:|:---:|:---:|:---:|:---:|:---|
| EDDQN (Paper Baseline) | 논문 딥러닝 강화학습 | 1,529 | 480 (55.05%) | 75.37 | 23.27% | PASS | 논문 3,000 Episode 학습 결과 |
| EST (Paper Benchmark) | 논문 규칙 기반 휴리스틱 | 1,566 | 463 (53.10%) | 66.32 | 22.72% | PASS | 논문 Figure 10 요약 기준 |
| DDQN (Paper Baseline) | 논문 강화학습 베이스라인 | 2,000 | 740 (84.86%) | 288.36 | 17.79% | PASS | 논문 3,000 Episode 학습 결과 |
