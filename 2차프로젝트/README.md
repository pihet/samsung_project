...
|:---|:---|:---:|:---:|:---:|:---:|:---:|:---|
| EDDQN (Paper Baseline) | 논문 딥러닝 강화학습 | 1,529 | 480 (55.05%) | 75.37 | 23.27% | FAIL (ID품질) | 논문 3,000 Episode 학습 결과 |
| EST (Paper Benchmark) | 논문 규칙 기반 휴리스틱 | 1,566 | 463 (53.10%) | 66.32 | 22.72% | - | 논문 Figure 10 요약 기준 |
